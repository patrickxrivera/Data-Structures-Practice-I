...
//     list.addToHead(3);
//     list.addToHead(39);
//     expect(list.removeFromHead().value).toEqual(39);
//     expect(list.removeFromHead().value).toEqual(3);
...
//     list.addToTail(18);
//     list.addToTail(109);
//     expect(list.removeFromTail().value).toEqual(109);
//     expect(list.removeFromTail().value).toEqual(18);
//     expect(list.removeFromTail()).toBeNull();
//     list.addToHead(16);
//     expect(list.removeFromTail().value).toEqual(16);
//     expect(list.removeFromTail()).toBeNull();
//   });
